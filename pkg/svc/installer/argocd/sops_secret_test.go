...
func TestUpsertSopsAgeSecret_Update(t *testing.T) {
	...
	const oldKey = "AGE-SECRET-KEY-1OLDKEY0000000000000000000000000000000000000000000000000"
	const newKey = "AGE-SECRET-KEY-1NEWKEY0000000000000000000000000000000000000000000000000"
