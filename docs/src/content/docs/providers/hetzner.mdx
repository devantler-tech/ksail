...
| --- | --- | --- | --- |
| `talos.iso` | int | tracked x86 default | Hetzner Cloud ISO/image ID for Talos Linux (look up the matching ARM ID in the Hetzner Cloud Console). Ignored when `schematicId` is set. |
