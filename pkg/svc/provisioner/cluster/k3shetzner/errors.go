...
var (
	...
	// live-bring-up boundary, after the K3s per-node cloud-init user_data is composed;
	// see [hetznerbase.ErrLiveBringUpNotImplemented] and devantler-tech/ksail#5515.
