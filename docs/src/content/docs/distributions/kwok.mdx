...
Consider other distributions when you need real containers ([Vanilla](/distributions/vanilla/), [K3s](/distributions/k3s/)), production-grade immutable infrastructure ([Talos](/distributions/talos/)), or isolated virtual clusters ([VCluster](/distributions/vcluster/)).
...
````bash
ksail cluster delete
ksail project init --distribution KWOK
ksail cluster create
````
