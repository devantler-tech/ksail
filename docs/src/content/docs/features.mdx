...
- **Native configuration** – Generates standard `kind.yaml`, `k3d.yaml`, and Talos patch files
- **No vendor lock-in** – Use generated configs directly with Kind, K3d, or Talos CLI
