...
// the talosprovisioner_test package.
//
//nolint:gochecknoglobals // export_test.go pattern requires global variables to expose internal sentinels
...
func (p *Provisioner) RetryTransientTalosAPICallForTest(
	...
	return p.retryTransientTalosAPICall(ctx, target, description, op)
}
