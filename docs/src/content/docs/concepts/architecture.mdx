...
- **`ksail open chat`** — provider-neutral interactive AI assistant supporting API keys, local OpenAI-compatible endpoints, and GitHub Copilot. See [AI Chat](/integrations/ai-chat/).
