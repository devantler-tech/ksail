...
The footer displays real-time quota information showing used/total requests, remaining percentage, and reset date when available. Example: `45/100 reqs · 55% · resets Feb 15`. For unlimited premium quota, shows `∞ reqs` instead of numeric total.
## Mode Comparison
