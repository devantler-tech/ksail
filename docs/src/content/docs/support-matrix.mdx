...
- Kubernetes provider requires an existing host Kubernetes cluster with privileged pod policy — see [Kubernetes Provider](/providers/kubernetes/) for setup details
