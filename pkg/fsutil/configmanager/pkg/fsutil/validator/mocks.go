...
func (_mock *MockValidator[T]) Validate(config T) *validator.ValidationResult {
	...
	if returnFunc, ok := ret.Get(0).(func(T) *validator.ValidationResult); ok {
...
func (_c *MockValidator_Validate_Call[T]) Return(validationResult *validator.ValidationResult) *MockValidator_Validate_Call[T] {
	_c.Call.Return(validationResult)
	return _c
}

func (_c *MockValidator_Validate_Call[T]) RunAndReturn(run func(config T) *validator.ValidationResult) *MockValidator_Validate_Call[T] {
	_c.Call.Return(run)
	return _c
}
