...
For upstream details, see the [Talos disk encryption docs](https://docs.siderolabs.com/talos/v1.13/configure-your-talos-cluster/storage-and-disk-management/disk-encryption/#going-from-unencrypted-to-encrypted-and-vice-versa).
...
- [Talos Disk Encryption](https://docs.siderolabs.com/talos/v1.13/configure-your-talos-cluster/storage-and-disk-management/disk-encryption/) — upstream Talos documentation
- [Talos System Disk Encryption Config](https://docs.siderolabs.com/talos/v1.13/reference/configuration/v1alpha1/config/#SystemDiskEncryptionConfig) — configuration reference
