...
- **.github/workflows/\*.md**: Agentic workflows (daily-refactor, daily-code-health, daily-docs, daily-builder, daily-workflow-maintenance, daily-plan, weekly-research, weekly-promote-ksail, ci-doctor, pr-fix, maintainer, etc.); each runs on a schedule or dispatch, and many operate in multiple phases
