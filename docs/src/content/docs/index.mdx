...
export const features = [
  ...
  { icon: "🤖", title: "AI Assistant", body: "Interactive chat with your choice of AI API provider or Copilot, plus an MCP server for external assistants." },
...
<img class="demo-recording" src="/demos/cluster-init.gif" alt="ksail project init scaffolds ksail.yaml and kind.yaml, cat shows the minimal declarative config, and re-running with --distribution K3s switches the distribution" />

```bash
# 1. Initialize a new project (pick any distribution)
ksail project init --name my-cluster --distribution Vanilla
