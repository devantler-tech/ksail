...
- **`ci.yaml`** — Runs on every PR and push to main; builds on Linux and macOS, runs unit and system tests, uploads coverage to Codecov
...
KSail uses six AI-powered daily workflows for continuous improvement (schedules spread at 4-hour gaps, 02–22 UTC):

- **`daily-refactor.md`** — Refactors code and simplifies code complexity
- **`daily-code-health.md`** — Improves test coverage and performance
- **`daily-plan.md`** — Plans upcoming work and roadmap items
