...
KSail is listed in the [GitHub MCP Registry](https://github.com/mcp) — search for `io.github.devantler-tech/ksail` to discover and install it directly from supported MCP clients.
