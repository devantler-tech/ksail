...
Manage clusters from Visual Studio Code with cluster sidebar, real-time cluster status view, status bar health indicator, interactive wizards, command palette (`Cmd+Shift+K`), K9s integration, and MCP server for AI assistants. Requires [KSail CLI](/installation/) and [Docker](https://www.docker.com/get-started/); [K9s](https://k9scli.io/) optional.
