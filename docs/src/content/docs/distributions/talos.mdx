...
rules:
  ...
  # Remove or modify this rule, then add specific verification rules.
  - image: "*"
    skip: true
  # Example: keyless (Cosign/OIDC) verification for registry.k8s.io images
  # - image: "registry.k8s.io/*"
  #   keyless:
  #     issuer: "https://accounts.google.com"
  #     subject: "krel-trust@k8s-releng-prod.iam.gserviceaccount.com"
  # Example: public-key verification for a private registry
