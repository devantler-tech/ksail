...
| `command` | ✓ | Full command path (e.g., `"ksail cluster info"`) |
| `output` | When non-empty | Combined stdout/stderr from the command |
| `error` | On error only | Human-readable error message |
