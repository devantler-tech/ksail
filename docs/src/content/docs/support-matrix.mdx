...
| Change                   | Vanilla (Kind) | K3s (K3d) | Talos    | VCluster (Vind) | KWOK (kwokctl) |
| ------------------------ | -------------- | --------- | -------- | --------------- | -------------- |
...
| Hetzner Server Type (CP) | N/A            | N/A       | Recreate | N/A             | N/A            |
| Hetzner Location         | N/A            | N/A       | Recreate | N/A             | N/A            |
| Hetzner Network          | N/A            | N/A       | Recreate | N/A             | N/A            |
