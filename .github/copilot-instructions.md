...
- **skills-lock.json**: Pins external Copilot Skills (sourced from registries like `github/awesome-copilot`) downloaded into `.agents/skills/`; analogous to a lock file — do not edit manually
- **.github/skills/\*/SKILL.md**: Local Copilot Skills defined in this repository (e.g., `refactor`)
- **.agents/skills/\*/SKILL.md**: External Copilot Skills downloaded from third-party registries and tracked by `skills-lock.json`
...
- **Copilot Instructions Blueprint Generator Skill**: Added `copilot-instructions-blueprint-generator` external Copilot Skill (sourced from `github/awesome-copilot`) to `.agents/skills/copilot-instructions-blueprint-generator/SKILL.md` and tracked in `skills-lock.json`; the skill generates comprehensive `copilot-instructions.md` files by analyzing existing codebase patterns and technology versions to guide GitHub Copilot toward project-consistent code generation
