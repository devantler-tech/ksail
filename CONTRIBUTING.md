...
- **CLI flags reference:** `docs/src/content/docs/cli-flags/` (auto-generated by `.github/scripts/generate-cli-flags-docs.sh` from `ksail --help` output; only appears after first build)
