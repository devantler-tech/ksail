...
The TUI footer displays real-time premium request usage — for example, `45/100 reqs · 55% · resets Feb 15` — or `∞ reqs` for unlimited entitlements. The footer may be hidden on narrow terminals.
