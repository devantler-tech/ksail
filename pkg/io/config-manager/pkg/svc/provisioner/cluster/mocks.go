...
func (_mock *MockFactory) Create(ctx context.Context, cluster *v1alpha1.Cluster) (clusterprovisioner.ClusterProvisioner, any, error) {
	...
	var r0 clusterprovisioner.ClusterProvisioner
	var r1 any
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha1.Cluster) (clusterprovisioner.ClusterProvisioner, any, error)); ok {
		return returnFunc(ctx, cluster)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *v1alpha1.Cluster) clusterprovisioner.ClusterProvisioner); ok {
		r0 = returnFunc(ctx, cluster)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(clusterprovisioner.ClusterProvisioner)
		}
	}
...
func (_c *MockFactory_Create_Call) Return(clusterProvisioner clusterprovisioner.ClusterProvisioner, v any, err error) *MockFactory_Create_Call {
	_c.Call.Return(clusterProvisioner, v, err)
	return _c
}

func (_c *MockFactory_Create_Call) RunAndReturn(run func(ctx context.Context, cluster *v1alpha1.Cluster) (clusterprovisioner.ClusterProvisioner, any, error)) *MockFactory_Create_Call {
	_c.Call.Return(run)
	return _c
}
