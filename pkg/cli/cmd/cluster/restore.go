...
func extractTarEntries(tarReader *tar.Reader, destDir string) error {
	for {
		...
		if header.Typeflag == tar.TypeDir {
			//nolint:gosec // G703: targetPath is sanitized above
		...
		//nolint:gosec // G703: targetPath sanitized via filepath.Clean
...
func injectRestoreLabels(
	...
	if err != nil {
		_ = os.Remove(tmpFile.Name()) //nolint:gosec // G703: tmpFile created by os.CreateTemp
