...
> [!NOTE]
> KSail sets the kubeconfig context after `ksail cluster create`. For context names by distribution, see [Companion Tools](/guides/companion-tools/).
...
Replace `k3d-dev` with the context name for your distribution (see [Companion Tools](/guides/companion-tools/)).
