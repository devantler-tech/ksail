...
When a cluster has **3 or more nodes** (control planes + workers ≥ 3), KSail automatically applies HA defaults to all Helm-based component installers:
...
Components that receive HA defaults automatically:
