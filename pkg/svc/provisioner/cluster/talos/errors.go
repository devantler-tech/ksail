...
var (
	...
	ErrStartNotSupported = errors.New("start not supported for Talos-on-Kubernetes: recreate the cluster instead")
	// ErrStopNotSupported is returned when Stop is called on a Talos-on-Kubernetes provisioner.
	ErrStopNotSupported = errors.New("stop not supported for Talos-on-Kubernetes: delete the cluster instead")
