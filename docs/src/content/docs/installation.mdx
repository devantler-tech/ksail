...
In headless environments (CI, remote servers, containers), use token-based authentication instead — see [AI Chat Assistant](/integrations/ai-chat/#token-authentication-headless-environments).
