...
The full `spec.provider.omni` field reference — every option with its type, default, and
description — is generated from the API types: see
[spec.provider.omni (OptionsOmni)](/configuration/declarative-configuration/#specprovideromni-optionsomni)
