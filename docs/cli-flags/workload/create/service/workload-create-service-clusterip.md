---
title: "ksail workload create service clusterip"
parent: "ksail workload create service"
...
Usage:
  ksail workload create service clusterip NAME [--tcp=<port>:<targetPort>] [--dry-run=server|client|none]
