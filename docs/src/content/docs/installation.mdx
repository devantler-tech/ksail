...
<Tabs>
  <TabItem label="Marketplace">
    ...
    3. Search for "KSail"
    4. Click **Install** on the extension by devantler-tech

    **Marketplace Link:** [KSail - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=devantler-tech.ksail)
