...
The Omni provider manages Talos Linux clusters through the [Sidero Omni](https://www.siderolabs.com/omni/) SaaS platform. Omni handles machine lifecycle, cluster orchestration, and configuration distribution — KSail connects to the Omni API to create, manage, and tear down clusters using machines you've already registered in Omni.
...
1. **Sidero Omni account** — Sign up at [siderolabs.com](https://www.siderolabs.com/omni/)
