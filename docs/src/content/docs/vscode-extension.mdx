...
| Icon | Meaning |
|------|---------|
| ✅ Green checkmark | Cluster is running |
| 🚫 Red slash | Cluster is stopped |
| 📦 Server icon | Status unknown |
| ⏳ Spinner | Cluster is being created |

Right-click a cluster for context-sensitive actions:

- **Running clusters:** Stop, Delete, Connect
- **Stopped clusters:** Start, Delete
...
The **Init** and **Create** commands launch multi-step wizards:
