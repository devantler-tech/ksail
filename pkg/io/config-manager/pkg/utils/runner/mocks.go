...
func (_mock *MockCommandRunner) Run(ctx context.Context, cmd *cobra.Command, args []string) (runner.CommandResult, error) {
	...
	var r0 runner.CommandResult
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *cobra.Command, []string) (runner.CommandResult, error)); ok {
		return returnFunc(ctx, cmd, args)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *cobra.Command, []string) runner.CommandResult); ok {
		r0 = returnFunc(ctx, cmd, args)
	} else {
		r0 = ret.Get(0).(runner.CommandResult)
	}
...
func (_c *MockCommandRunner_Run_Call) Return(commandResult runner.CommandResult, err error) *MockCommandRunner_Run_Call {
	_c.Call.Return(commandResult, err)
	return _c
}

func (_c *MockCommandRunner_Run_Call) RunAndReturn(run func(ctx context.Context, cmd *cobra.Command, args []string) (runner.CommandResult, error)) *MockCommandRunner_Run_Call {
	_c.Call.Return(run)
	return _c
}
