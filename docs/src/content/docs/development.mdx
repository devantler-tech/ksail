...
3. **Tag-triggered CD:** Any push of a version tag triggers `.github/workflows/cd.yaml`, which publishes the release; see the `cd.yaml` workflow description above for the current list of release outputs and follow-up publishing jobs.
