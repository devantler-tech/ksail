...
refresh into a different identity. Reusing a captured selection preserves its
expiry and endpoint settings; node-group inventory also retains the captured
CloudFormation endpoint if the process environment changes.
