...
KSail embeds kubectl, helm, kind (Vanilla), k3d (K3s), flux, argocd, and sops as Go libraries — no separate installation needed. All tools are accessible through KSail's unified CLI.
