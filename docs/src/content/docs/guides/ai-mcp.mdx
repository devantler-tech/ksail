...
- **Available tools**: KSail consolidates its commands into a small set of MCP tools grouped by permission level. For the complete, auto-generated tool catalog with subcommands and flags, see the [MCP Server reference](/mcp/#available-tools).
