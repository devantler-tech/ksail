...
Flags:
  ...
  -h, --help                           help for info
      ...
      --kubeconfig string              Path to the kubeconfig file to use for CLI requests. (default "/home/runner/.kube/config")
...
Use "ksail cluster info [command] --help" for more information about a command.
```
