...
- **`ksail open chat`** — interactive AI assistant using GitHub Copilot SDK; supports Agent and Plan modes. See [AI Chat](/ai-chat/).
- **`ksail open mcp`** — Model Context Protocol server for Claude and other AI assistants; tools are auto-generated from the CLI command tree and grouped into read/write pairs. See [MCP](/mcp/).
