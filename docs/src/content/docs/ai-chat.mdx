...
| Mode | Icon | Read Tools | Write Tools | Best For |
|------|------|------------|-------------|----------|
| **Interactive** | `</>` | ✅ Auto | ✅ With approval | Cluster operations, deploying workloads |
| **Plan** | `≡` | ❌ None | ❌ None | Learning workflows, reviewing changes |
| **Autopilot** | `⚡` | ✅ Auto | ✅ Auto (no prompts) | Trusted or repetitive workflows |
