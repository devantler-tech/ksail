...
func (_mock *MockManager) Ensure(ctx context.Context, opts EnsureOptions) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, EnsureOptions) error); ok {
...
func (_c *MockManager_Ensure_Call) Run(run func(ctx context.Context, opts EnsureOptions)) *MockManager_Ensure_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 EnsureOptions
		if args[1] != nil {
			arg1 = args[1].(EnsureOptions)
		}
		run(
			arg0,
			arg1,
...
func (_mock *MockManager) UpdateTargetRevision(ctx context.Context, opts UpdateTargetRevisionOptions) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, UpdateTargetRevisionOptions) error); ok {
		r0 = returnFunc(ctx, opts)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockManager_UpdateTargetRevision_Call) Run(run func(ctx context.Context, opts UpdateTargetRevisionOptions)) *MockManager_UpdateTargetRevision_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 UpdateTargetRevisionOptions
		if args[1] != nil {
			arg1 = args[1].(UpdateTargetRevisionOptions)
		}
		run(
			arg0,
			arg1,
...
func (_mock *MockStatusProvider) GetStatus(ctx context.Context) (Status, error) {
	...
	var r0 Status
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (Status, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) Status); ok {
		r0 = returnFunc(ctx)
	} else {
		r0 = ret.Get(0).(Status)
	}
