...
// (charts/ksail-operator/crds/ksail.io_clusters.yaml) after changing the API types. Mirrors the
...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen@v0.19.0 crd paths=. output:crd:dir=../../../../charts/ksail-operator/crds
