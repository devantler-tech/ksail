...
- uses: devantler-tech/ksail/.github/actions/ksail-cluster@main
  with:
    ...
    gitops: "true"                # enable GitOps reconcile step
  env:
...
See [Ephemeral Clusters (--ttl)](/guides/ephemeral-clusters/) for the full TTL guide.
