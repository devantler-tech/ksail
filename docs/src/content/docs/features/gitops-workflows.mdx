...
### Excluding Kustomizations from Reconciliation

Some Kustomizations may be intentionally long-running or should not block reconciliation. You can exclude specific Kustomizations from progress monitoring using either an annotation or a CLI flag.
