...
the private network (or behind a load balancer / floating IP you place in front). Validation rejects
a role left with no public IPv4, no public IPv6, **and** no private network.
