...
2. **Create the target cluster** — any distribution works:
   ...
   ```bash
   ksail project init --name new-home --distribution K3s
...
- [Day-2 Operations](/guides/day-2-operations/) — diagnose and repair running clusters
- [Cluster Provisioning](/guides/cluster-provisioning/) — updating clusters and drift detection
