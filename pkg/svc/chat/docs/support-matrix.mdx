...
| Control Planes           | Recreate       | Recreate  | Planned  |
| Workers                  | Recreate       | In-place  | Planned  |
...
- Talos supports the broadest set of in-place updates; node scaling is planned but not yet implemented
