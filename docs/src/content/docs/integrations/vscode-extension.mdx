...
The extension exposes KSail as an MCP server for AI assistants in VSCode (e.g., GitHub Copilot). No separate configuration is needed — the extension handles server lifecycle automatically. See [MCP Server](/integrations/mcp/) for details on available tools.
...
For build instructions, architecture overview, and development workflows, see [vsce/README.md](https://github.com/devantler-tech/ksail/blob/main/vsce/README.md) in the repository.

## Further Reading

- [Features Overview](/guides/) — All KSail features at a glance
- [MCP Server](/integrations/mcp/) — MCP server setup and tool reference
- [AI Chat Assistant](/integrations/ai-chat/) — Terminal-based AI chat
