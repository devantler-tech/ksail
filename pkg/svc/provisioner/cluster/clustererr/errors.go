...
// ErrClusterNotFoundInDistributions is returned when a cluster was not found in any distribution.
var ErrClusterNotFoundInDistributions = errors.New("cluster not found in any distribution")
