...
Encrypted secrets in your source directory are decrypted transparently during sync — no manual plugin setup required. For key resolution details and all `spec.cluster.sops` options, see [Secret Management](/guides/secret-management/).
