...
- Benchmarks: `go test -bench=. -benchmem -count=5 ./path/to/package/`
- 20% noise floor for benchmark comparisons
...
2. Run benchmarks locally before changes: `go test -bench=. -benchmem -count=5 ./path/to/package/`
