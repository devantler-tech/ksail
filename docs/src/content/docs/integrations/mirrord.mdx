...
- **Ephemeral clusters work well with mirrord** — create a short-lived cluster with `ksail cluster create --ttl 1h` to isolate your debugging session. See [Ephemeral Clusters](/features/ephemeral-clusters/) for details.
