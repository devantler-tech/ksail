...
Install the ksail plugin for [GitHub Copilot CLI](https://docs.github.com/en/copilot/how-tos/copilot-cli) or [Claude Code](https://docs.claude.com/en/docs/claude-code/plugins) to auto-register ksail's MCP server and a ksail expertise skill. See the [AI Plugins guide](https://ksail.devantler.tech/ai-plugins/) for setup instructions.
