...
- **Reset date** — When your quota renews (e.g., `resets Feb 15`)

**Example:** `45/100 reqs · 55% · resets Feb 15`

### Display Behavior

- Quota appears automatically when usage data is available from GitHub Copilot
- Only the "premium" quota category is shown (unlimited categories are hidden for clarity)
