...
- Kubernetes provider runs nested clusters as pods inside an existing host cluster — see [Kubernetes Provider](/providers/kubernetes/) for setup details; no Docker required on the client machine
