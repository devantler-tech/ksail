...
### Does KSail accept feature requests?

Yes! Open a [feature request issue](https://github.com/devantler-tech/ksail/issues/new/choose) with your proposal. We prioritize features based on community interest and project goals.

### Can I sponsor KSail development?

Yes! KSail is supported through [GitHub Sponsors](https://github.com/sponsors/devantler). Sponsorships help maintain the project, add new distributions/providers, and cover cloud testing costs.
