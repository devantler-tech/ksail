...
// GetInjectConfirmFlags returns the injectConfirmFlags function for testing.
func GetInjectConfirmFlags() func(copilot.ToolInvocation, []string) copilot.ToolInvocation {
	return injectConfirmFlags
}

// GetConfirmFlagsForInvocation returns the confirmFlagsForInvocation function for testing.
func GetConfirmFlagsForInvocation() func(
	map[string]toolgen.ToolDefinition, string, copilot.ToolInvocation,
) []string {
	return confirmFlagsForInvocation
}
