...
Use `for b.Loop()` style (Go 1.26+). PRs are auto-benchmarked against `main`; see [BENCHMARK-REGRESSION.md](https://github.com/devantler-tech/ksail/blob/main/docs/BENCHMARK-REGRESSION.md). Use `ksail cluster create --benchmark` for per-component timings.
